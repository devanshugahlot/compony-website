...
const AccountingBillingSoftware = () => {
  return (
    <>
            ...
            <div className="row h-100">
              <div className="col-lg-12 my-auto">
                <div className="header-content mx-auto">
                  <h1 className="mb-5">
                    {/* Blockchain Finance Management */}Accounting & Billing Software Development Company</h1>
...
export default AccountingBillingSoftware
