...
import './NFTMusicMarketplaceDevelopment.css'
import AutoPlaymusic from './Nftmusicslider'
const NFTMusicMarketplaceDevelopment = () => {
  return (
    <div>
...
export default NFTMusicMarketplaceDevelopment
