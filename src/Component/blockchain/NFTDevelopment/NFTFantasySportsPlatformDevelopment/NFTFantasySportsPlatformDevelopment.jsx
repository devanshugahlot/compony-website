...
import './NFTFantasySportsPlatformDevelopment.css'
import AutoPlayfantasy from './NftFantasySlider'
const NFTFantasySportsPlatformDevelopment = () => {
  return (
    <div>
      
    <main id="nft_marketplace_main">
<section className="nft_marketplace_banner">
  <div className="container">
    <div className="row align-items-center justify-content-center banner_img_col">
      <div className="col-lg-6 col-12">
        <div className="banner_sec">
          <h1 className="title"><span className="cus_title">NFT Marketplace</span> <br /> DEVELOPMENT COMPANY</h1>
...
<section className="nft_marketplace_clone_sec">
  <div className="container">
          ...
          <div className="col-lg-7 col-md-12 col-sm-12 col-12 nft_marketplace_col_styling">
            <div className="row">
              <div className="col-lg-4 col-md-6 col-12">
                <div className="clones_box">
                  <div className="contents" data-toggle="modal" data-target="#popup_form_modal">
                    <img src="asset/images/inner-pages/nft_marketplace/bannericon.png" alt="Opensea Clone" title="Opensea Clone" className="icon_sprite" style={{objectPosition: '-21px -1px'}} />
                    <div className="sub_title">Opensea <br /> Clone</div>
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12">
                <div className="clones_box">
                  <div className="contents" data-toggle="modal" data-target="#popup_form_modal">
                    <img src="asset/images/inner-pages/nft_marketplace/bannericon.png" alt="Rarible Clone" title="Rarible Clone" className="icon_sprite" style={{objectPosition: '-85px -1px'}} />
                    <div className="sub_title">Rarible <br /> Clone</div>
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12">
                <div className="clones_box">
                  <div className="contents" data-toggle="modal" data-target="#popup_form_modal">
                    <img src="asset/images/inner-pages/nft_marketplace/bannericon.png" alt="NBA Top Shot Clone" title="NBA Top Shot Clone" className="icon_sprite" style={{objectPosition: '-139px -1px'}} />
                    <div className="sub_title">NBA Top Shot <br /> Clone</div>
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12">
                <div className="clones_box">
                  <div className="contents" data-toggle="modal" data-target="#popup_form_modal">
                    <img src="asset/images/inner-pages/nft_marketplace/bannericon.png" alt="SuperRare Clone" title="SuperRare Clone" className="icon_sprite" style={{objectPosition: '-195px -1px'}} />
                    <div className="sub_title">SuperRare <br /> Clone</div>
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12">
                <div className="clones_box">
                  <div className="contents" data-toggle="modal" data-target="#popup_form_modal">
                    <img src="asset/images/inner-pages/nft_marketplace/bannericon.png" alt="Crytopunks Clone" title="Crytopunks Clone" className="icon_sprite" style={{objectPosition: '-256px -1px'}} />
                    <div className="sub_title">Crytopunks <br /> Clone</div>
                  </div>
                </div>
              </div>
              <div className="col-lg-4 col-md-6 col-12">
                <div className="clones_box">
                  <div className="contents" data-toggle="modal" data-target="#popup_form_modal">
                    <img src="asset/images/inner-pages/nft_marketplace/bannericon.png" alt="Foundation Clone" title="Foundation Clone" className="icon_sprite" style={{objectPosition: '-312px -1px'}} />
                    <div className="sub_title">Foundation <br /> Clone</div>
                  </div>
                </div>
              </div>
            </div>
            <div className="clones_btn_sec">
              <a className="btn clones_btn" data-toggle="modal" data-target="#popup_form_modal">Get A Free Demo</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="row justify-content-center align-items-center">
      <div className="col-lg-5 col-12 order-2 order-lg-1">
        <div className="img_sec ">
          <img src="https://www.osiztechnologies.com/asset/inner-pages-new/nft-marketplace-development/nft-marketplace-sec.webp" alt="NFT Game Development Company" title="NFT Game Development Company" loading="eager" className="img-fluid lazyload" />
        </div>
      </div>
      <div className="col-lg-7 col-12 order-1 order-lg-2">
        <div className>
          ...
          <div className="nft_game_dev_about_btn_sec">
            ...
            <a href="https://telegram.me/Osiz_Tech" className="btn nft_game_dev_about_btn1" target="_blank"><i className="fab fa-telegram" />&nbsp;Telegram</a>
          </div>
        </div>
      </div>
    </div>
...
<section className="nft_marketplace_clone_whitelabel">
  <div className="container">
    <div className="row justify-content-center align-items-center">
      ...
      <div className="col-lg-5 col-12">
        <div className="img_sec ">
          <img src="https://www.osiztechnologies.com/asset/inner-pages-new/nft-marketplace-development/whitelabel-img.webp" alt="NFT Game Development Company" title="NFT Game Development Company" loading="eager" className="img-fluid lazyload" />
        </div>
      </div>
    </div>
  </div>
</section>
<section className="nft_marketplace_ready">
  <div className="container">
    <h2 className="title">Ready To Deploy NFT Marketplace Clones</h2>
    <div className="row justify-content-center align-items-center">
      <div className="col-lg-10">
        <div className="tab_sec_main">
          <div className="row justify-content-center">
            <div className="col-lg-4 col-12 bor_rght">
              <div className="tab_item_sec ">
                <ul className="nav flex-column nav-tabs" role="tablist">
                  <li className="nav-item">
                    <a className="nav-link active show" href="#opensea_tab" data-id="opensea_tab" role="tab" data-toggle="tab">Opensea Clone Script</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" href="#rarible_tab" data-id="rarible_tab" role="tab" data-toggle="tab">Rarible Clone Script</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" href="#foundation_tab" data-id="foundation_tab" role="tab" data-toggle="tab">Foundation Clone Script</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" href="#axie_infinity_tab" data-id="axie_infinity_tab" role="tab" data-toggle="tab">Axie Infinity Clone Script</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" href="#cryptopunks_tab" data-id="cryptopunks_tab" role="tab" data-toggle="tab">CryptoPunks Clone Script</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link" href="#superrare_tab" data-id="rarible_tab" role="tab" data-toggle="tab">SuperRare Clone Script</a>
                  </li>
                </ul>
              </div>
            </div>
            <div className="col-lg-8 col-12">
              ...
              <div className="tab-content">
                <div role="tabpanel" className="tab-pane in active" id="opensea_tab">
                ...
                <div role="tabpanel" className="tab-pane" id="rarible_tab">
                  <div className="ready_box">
                    <div className="head_sec">
                      <img src="https://www.osiztechnologies.com/asset/inner-pages-new/nft-marketplace-development/tab-icons.webp" alt="Rarible Clone Script" title="Rarible Clone Script" className="sprite_icons" style={{objectPosition: '-189px 0px'}} />
                      <h3 className="sub_title">Rarible Clone Script</h3>
                    </div>
                    <p className="sub_contents">Rarible Clone Script is the next dependable NFT Marketplace clone script in the NFT Era. Many NFT users and investors have investing in the rarible marketplace, by considering this, Osiz develops you a enrich
                      rarible clone script that helps NFT Traders to be an entrepreneur of NFT Marketplace.</p>
                    <div className="ready_btn_sec">
                      <a className="btn ready_btn" href="https://www.osiztechnologies.com/blog/rarible-clone-script" target="_blank">Explore More <i className="fa fa-arrow-right" aria-hidden="true" /></a>
                    </div>
                  </div>
                </div>
                <div role="tabpanel" className="tab-pane" id="foundation_tab">
                  <div className="ready_box">
                    <div className="head_sec">
                      <img src="https://www.osiztechnologies.com/asset/inner-pages-new/nft-marketplace-development/tab-icons.webp" alt="Foundation Clone Script" title="Foundation Clone Script" className="sprite_icons" style={{objectPosition: '-380px 0px'}} />
                      <h3 className="sub_title">Foundation Clone Script</h3>
                    </div>
                    <p className="sub_contents">Foundation Clone script is the exact replica of popular NFT Marketplace like foundation that facilitates the creation and selling of NFTs. Foundation Clone is build on Ethereum blockchain main aims to provide
                      artists and creators with a decentralized, non-fungible way to create, sell and buy NFT's.</p>
                    <div className="ready_btn_sec">
                      <a className="btn ready_btn" href="https://www.osiztechnologies.com/blog/create-nft-marketplace-like-foundation-app" target="_blank">Explore More <i className="fa fa-arrow-right" aria-hidden="true" /></a>
                    </div>
                  </div>
                </div>
                <div role="tabpanel" className="tab-pane" id="axie_infinity_tab">
                  <div className="ready_box">
                    <div className="head_sec">
                      <img src="https://www.osiztechnologies.com/asset/inner-pages-new/nft-marketplace-development/tab-icons.webp" alt="Axie Infinity Clone Script" title="Axie Infinity Clone Script" className="sprite_icons" style={{objectPosition: '-532px 0px'}} />
                      <h3 className="sub_title">Axie Infinity Clone Script</h3>
                    </div>
                    <p className="sub_contents">Axie Infinity clone script is a NFT Based blockchain game clone script built with cutting edge technologies to generate fascinating creatures, Axies, that players can collect as pets. Axie Players aim to
                      battle, breed, collect, raise funds and earn endless profit with out white label axie infinity clone.</p>
                    <div className="ready_btn_sec">
                      <a className="btn ready_btn" href="https://www.osiztechnologies.com/blog/axie-infinity-clone-script" target="_blank">Explore More <i className="fa fa-arrow-right" aria-hidden="true" /></a>
                    </div>
                  </div>
                </div>
                <div role="tabpanel" className="tab-pane" id="cryptopunks_tab">
                  <div className="ready_box">
                    <div className="head_sec">
                      <img src="https://www.osiztechnologies.com/asset/inner-pages-new/nft-marketplace-development/tab-icons.webp" alt="CryptoPunks Clone Script" title="CryptoPunks Clone Script" className="sprite_icons" style={{objectPosition: '-683px 0px'}} />
                      <h3 className="sub_title">CryptoPunks Clone Script</h3>
                    </div>
                    <p className="sub_contents">CryptoPunks clone script is NFT Digital Collectible Marketplace Script which resembles same as cryptopunks which is one of the earliest non-fungible token projects developed on the Ethereum blockchain. Osiz
                      builds you a CryptoPunk clone script shows an NFT project that displays special pixel image characters.</p>
                    <div className="ready_btn_sec">
                      <a className="btn ready_btn" href="https://www.osiztechnologies.com/blog/cryptopunks-clone-script" target="_blank">Explore More <i className="fa fa-arrow-right" aria-hidden="true" /></a>
                    </div>
                  </div>
                </div>
                <div role="tabpanel" className="tab-pane" id="superrare_tab">
                  <div className="ready_box">
                    <div className="head_sec">
                      <img src="https://www.osiztechnologies.com/asset/inner-pages-new/nft-marketplace-development/tab-icons.webp" alt="SuperRare Clone Script" title="SuperRare Clone Script" className="sprite_icons" style={{objectPosition: '-835px 0px'}} />
                      <h3 className="sub_title">SuperRare Clone Script</h3>
                    </div>
                    <p className="sub_contents">SuperRare Clone Script is an art-focused NFT platform script that helps to build your own NFT art based platform like superrare where users can trade curated NFTs from a select group of handpicked artists.
                      Osiz is a leading NFT Marketplace Development company provides superrare clone script with ultimate features.</p>
                    <div className="ready_btn_sec">
                      <a className="btn ready_btn" href="https://www.osiztechnologies.com/blog/superrare-clone-script" target="_blank">Explore More <i className="fa fa-arrow-right" aria-hidden="true" /></a>
                    </div>
                  </div>
                </div>
              </div>
...
<section className="nft_marketplace_usecase">
  <div className="container">
    <h2 className="title">NFT Use Cases</h2>
    ...
    <div className="row justify-content-center">
      <div className="col-lg-2 col-md-6 cus_col">
        <div className="tech_stact_card ">
          <img src="https://www.osiztechnologies.com/asset/inner-pages-new/nft-marketplace-development/various_blockchain.svg" alt="Various Blockchains" title="Various Blockchains" className="various_blockchain" style={{objectPosition: '26px 0px'}} />
          <p className="sub_title">Ethereum</p>
        </div>
      </div>
      <div className="col-lg-2 col-md-6 cus_col">
        <div className="tech_stact_card ">
          <img src="https://www.osiztechnologies.com/asset/inner-pages-new/nft-marketplace-development/various_blockchain.svg" alt="Various Blockchains" title="Various Blockchains" className="various_blockchain" style={{objectPosition: '-197px 0px'}} />
          <p className="sub_title">Solana</p>
        </div>
      </div>
      <div className="col-lg-2 col-md-6 cus_col">
        <div className="tech_stact_card ">
          <img src="https://www.osiztechnologies.com/asset/inner-pages-new/nft-marketplace-development/various_blockchain.svg" alt="Various Blockchains" title="Various Blockchains" className="various_blockchain" style={{objectPosition: '-416px 0px'}} />
          <p className="sub_title">Binance Smart Chain</p>
        </div>
      </div>
      <div className="col-lg-2 col-md-6 cus_col">
        <div className="tech_stact_card ">
          <img src="https://www.osiztechnologies.com/asset/inner-pages-new/nft-marketplace-development/various_blockchain.svg" alt="Various Blockchains" title="Various Blockchains" className="various_blockchain" style={{objectPosition: '-624px 0px'}} />
          <p className="sub_title">Polygon</p>
        </div>
      </div>
      <div className="col-lg-2 col-md-6 cus_col">
        <div className="tech_stact_card ">
          <img src="https://www.osiztechnologies.com/asset/inner-pages-new/nft-marketplace-development/various_blockchain.svg" alt="Various Blockchains" title="Various Blockchains" className="various_blockchain" style={{objectPosition: '-857px 0px'}} />
          <p className="sub_title">TRON</p>
        </div>
      </div>
      <div className="col-lg-2 col-md-6 cus_col">
        <div className="tech_stact_card ">
          <img src="https://www.osiztechnologies.com/asset/inner-pages-new/nft-marketplace-development/various_blockchain.svg" alt="Various Blockchains" title="Various Blockchains" className="various_blockchain" style={{objectPosition: '-1086px 0px'}} />
          <p className="sub_title">Polkadot</p>
        </div>
      </div>
    </div>
  </div>
</section>
<section className="nft_marketplace_techstack">
  <div className="container">
    <h2 className="title">Technology Stack</h2>
    <div>
      <img src="https://www.osiztechnologies.com/asset/inner-pages-new/nft-marketplace-development/techstack.webp" alt="Technology Stack" title="Technology Stack" loading="eager" className="img-fluid lazyload" />
    </div>
  </div>
</section>
<section className="nft_marketplace_whychoose">
  <div className="container">
    <div className="row justify-content-center align-items-center">
      <div className="col-lg-5 col-12 order-2 order-lg-1">
        <div className="img_sec ">
          <img src="https://www.osiztechnologies.com/asset/inner-pages-new/nft-marketplace-development/whychoose-img.webp" alt="Why Choose Osiz For NFT Marketplace Development?" title="Why Choose Osiz For NFT Marketplace Development?" loading="eager" className="img-fluid lazyload" />
        </div>
      </div>
      <div className="col-lg-7 col-12 order-1 order-lg-2">
        <div className>
    ...
    <div className="row justify-content-center scroll_row">
      <div className="col-lg-3 col-md-6 col-12">
        <div className="whychoose_box">14 Years of Experience</div>
      </div>
      <div className="col-lg-3 col-md-6 col-12">
        <div className="whychoose_box">Agile Development Process</div>
      </div>
      <div className="col-lg-3 col-md-6 col-12">
        <div className="whychoose_box">Dedicated Development Team</div>
      </div>
      <div className="col-lg-3 col-md-6 col-12">
        <div className="whychoose_box">Globally Recognized</div>
      </div>
      <div className="col-lg-3 col-md-6 col-12">
        <div className="whychoose_box">100% NFT White Label Solutions</div>
      </div>
      <div className="col-lg-3 col-md-6 col-12">
        <div className="whychoose_box">End-to-End NFT Marketplace Solutions</div>
      </div>
      <div className="col-lg-3 col-md-6 col-12">
        <div className="whychoose_box">Enterprise-grade Solutions</div>
      </div>
      <div className="col-lg-3 col-md-6 col-12">
        <div className="whychoose_box">State-of-the-Art Technologies</div>
      </div>
      <div className="col-lg-3 col-md-6 col-12">
        <div className="whychoose_box">Long-term Business Support</div>
      </div>
      <div className="col-lg-3 col-md-6 col-12">
        <div className="whychoose_box">Global Quality Standards</div>
      </div>
      <div className="col-lg-3 col-md-6 col-12">
        <div className="whychoose_box">Best in Class Project Development</div>
      </div>
      <div className="col-lg-3 col-md-6 col-12">
        <div className="whychoose_box">Support &amp; Maintenance Services</div>
      </div>
    </div>
  </div>
</section>
...
export default NFTFantasySportsPlatformDevelopment
