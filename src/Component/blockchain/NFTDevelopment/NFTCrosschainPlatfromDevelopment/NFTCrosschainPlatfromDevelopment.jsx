...
import './NFTCrosschainPlatfromDevelopment.css'
import AutoPlaycrosschain from './NftCrosschainSlider'
const NFTCrosschainPlatfromDevelopment = () => {
  return (
    <div>
...
export default NFTCrosschainPlatfromDevelopment
