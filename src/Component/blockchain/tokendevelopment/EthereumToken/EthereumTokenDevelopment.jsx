...
import './EthereumTokenDevelopment.css'
const EthereumTokenDevelopment = () => {
  return (
     <div>
  &lt;&gt;
  <main id="token_dev_main">
    <section className="token_dev_banner">
        ...
        <div className="row align-items-center justify-content-center">
          ...
          <div className="col-lg-6 col-12 order-1 order-lg-2">
            <div className="banner_cont_sec">
              <h1 className="title"><span className="bnr_bld_title">TOKEN</span> <br /> Development Company</h1>
    ...
    <section className="token_dev_crypto_sec">
        ...
        <div className="odd_serv_cardsec">
          <div className="card">
            <div className="imgBx" data-taxt="Design">
              <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/odd-service1.svg" alt="Liquidity-Provision-and-Market-Making" title="Liquidity Provision and Market Making" />
            </div>
          ...
          <div className="card">
            <div className="imgBx" data-taxt="Code">
              <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/odd-service2.svg" alt="Token-Wallet-Development" title="Token Wallet Development" />
            </div>
            <div className="content_sec">
              <div>
          ...
          <div className="card">
            <div className="imgBx" data-taxt="startup">
              <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/odd-service3.svg" alt="White-Paper-Creation" title="White Paper Creation" />
            </div>
            <div className="content_sec">
              <div>
          ...
          <div className="card">
            <div className="imgBx" data-taxt="Money">
              <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/odd-service4.svg" alt="ICO-Development" title="ICO Development" />
            </div>
            <div className="content_sec">
              <div>
      ...
      <div className="container">
        <div className="row align-items-center" id="token_dev_idea_card">
          <div className="col-xl-6 col-12">
            <div className="sub_title">Create Your Tokens Instantly</div>
            <div className="title">In Just A Few Hours</div>
    ...
    <section className="token_dev_techstack">
      <div className="container">
        ...
        <p className="contents">Ultimate Tech Stack for Flawless Tokens</p>
        <div className="img_sec">
          <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/techstack.webp" alt="Our Technology Stack" title="Our Technology Stack" className="img-fluid" />
        </div>
      </div>
    </section>
    ...
    <section className="token_dev_join_cardsec">
      <div className="container">
        <div className="row" id="token_dev_join_card">
          <div className="col-xl-7">
            <div className="title">Join the Path to Unlock Your Full Potential</div>
            <div className="token_dev_btn_sec">
              <button data-toggle="modal" data-target="#popup_form_modal" className="btn token_dev_btn"><span>Claim Your Free Demo Now</span></button>
            </div>
          </div>
        ...
        <div className="row align-items-center">
          <div className="col-lg-2 col-md-4 col-sm-4 col-6">
            <div className="platform_list">
              <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/platform-icons.webp" alt="ethereum" title="ethereum" className="sprite_icons" style={{objectPosition: '15px 0px'}} />
              <div className="sub_title">ethereum</div>
            </div>
          </div>
          <div className="col-lg-2 col-md-4 col-sm-4 col-6">
            <div className="platform_list">
              <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/platform-icons.webp" alt="Eos" title="Eos" className="sprite_icons" style={{objectPosition: '-202px 0px'}} />
              <div className="sub_title">Eos</div>
            </div>
          </div>
          <div className="col-lg-2 col-md-4 col-sm-4 col-6">
            <div className="platform_list">
              <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/platform-icons.webp" alt="Tezos" title="Tezos" className="sprite_icons" style={{objectPosition: '-432px 0px'}} />
              <div className="sub_title">Tezos</div>
            </div>
          </div>
          <div className="col-lg-2 col-md-4 col-sm-4 col-6">
            <div className="platform_list">
              <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/platform-icons.webp" alt="Hyperledger" title="Hyperledger" className="sprite_icons" style={{objectPosition: '-650px 0px'}} />
              <div className="sub_title">Hyperledger</div>
            </div>
          </div>
          <div className="col-lg-2 col-md-4 col-sm-4 col-6">
            <div className="platform_list">
              <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/platform-icons.webp" alt="Stellar" title="Stellar" className="sprite_icons" style={{objectPosition: '-882px 0px'}} />
              <div className="sub_title">Stellar</div>
            </div>
          </div>
          <div className="col-lg-2 col-md-4 col-sm-4 col-6">
            <div className="platform_list">
              <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/platform-icons.webp" alt="Matic" title="Matic" className="sprite_icons" style={{objectPosition: '-1099px 0px'}} />
              <div className="sub_title">Matic</div>
            </div>
          </div>
          <div className="col-lg-2 col-md-4 col-sm-4 col-6">
            <div className="platform_list">
              <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/platform-icons.webp" alt="Fantom" title="Fantom" className="sprite_icons" style={{objectPosition: '-1264px 0px'}} />
              <div className="sub_title">Fantom</div>
            </div>
          </div>
          <div className="col-lg-2 col-md-4 col-sm-4 col-6">
            <div className="platform_list">
              <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/platform-icons.webp" alt="Ripple" title="Ripple" className="sprite_icons" style={{objectPosition: '-1487px 0px'}} />
              <div className="sub_title">Ripple</div>
            </div>
          </div>
          <div className="col-lg-2 col-md-4 col-sm-4 col-6">
            <div className="platform_list">
              <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/platform-icons.webp" alt="Solana" title="Solana" className="sprite_icons" style={{objectPosition: '-1720px 0px'}} />
              <div className="sub_title">Solana</div>
            </div>
          </div>
          <div className="col-lg-2 col-md-4 col-sm-4 col-6">
            <div className="platform_list">
              <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/platform-icons.webp" alt="Polygon" title="Polygon" className="sprite_icons" style={{objectPosition: '-1938px 0px'}} />
              <div className="sub_title">Polygon</div>
            </div>
          </div>
          <div className="col-lg-2 col-md-4 col-sm-4 col-6">
            <div className="platform_list">
              <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/platform-icons.webp" alt="Binance smart chain" title="Binance smart chain" className="sprite_icons" style={{objectPosition: '-2163px 0px'}} />
              <div className="sub_title">Binance smart chain</div>
            </div>
          </div>
          <div className="col-lg-2 col-md-4 col-sm-4 col-6">
            <div className="platform_list">
              <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/platform-icons.webp" alt="Huabi ECO Chain" title="Huabi ECO Chain" className="sprite_icons" style={{objectPosition: '-2383px 0px'}} />
              <div className="sub_title">Huabi ECO Chain</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section className="token_dev_whyosiz">
      <div className="container">
        <div className="row justify-content-center align-items-center">
          <div className="col-lg-5 col-12 order-2 order-lg-1">
            <img src="https://www.osiztechnologies.com/asset/inner-pages-new/token-development/why-osiz.webp" alt="Why Choose Osiz For Cryptocurrency Token Development Services?" title="Why Choose Osiz For Cryptocurrency Token Development Services?" className="img-fluid" />
          </div>
          <div className="col-lg-7 col-12 order-1 order-lg-2">
            <div>
...
export default EthereumTokenDevelopment
