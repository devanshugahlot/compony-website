            ...
            <div className="container">
              <div className="row align-items-center">
                ...
                <div className="col-lg-5 col-12 pl-lg-0">
                  <img src="https://www.osiztechnologies.com/asset/images/inner-pages/private_public_blockchain_development/why-choose-osiz-for-public-private-blockchain-development.png" alt="Hire Our Dedicated Blockchain Developer
      ...
      " className="img-fluid hire-img" />
          ...
          <section className="metaverse_dev_why">
            <div className="container">
              <div className="row align-items-center">
                <div className="col-lg-5 col-12 pl-lg-0">
                  <img src="https://www.osiztechnologies.com/asset/images/inner-pages/private_public_blockchain_development/hire-our-dedicated-blockchain-developer.png" alt="Why Choose Osiz For Public / Private Blockchain Development?
